...
const Achievements: React.FC = () => {
  ...
  if (loading) {
    return (
      <div className="bg-slate-900/60 backdrop-blur-xl border border-white/10 shadow-xl rounded-2xl p-5 h-full flex flex-col items-center justify-center">
      ...
      >
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-3">
             <div className="flex items-center gap-1.5 px-2 py-1 bg-orange-500/10 border border-orange-500/20 rounded-md" title="Current Streak">
                ...
                <span className="text-xs font-bold text-orange-400">0 Days</span>
             </div>
       ...
       <div className="mb-6">
         <div className="flex justify-between items-end mb-2">
             ...
             <span className="text-sm text-slate-200 font-bold">{xp} <span className="text-slate-500">/ {maxXp}</span></span>
         </div>
         ...
         <p className="text-xs text-slate-500 mt-2 text-right">{maxXp - xp} XP to Level {level + 1}</p>
       </div>
