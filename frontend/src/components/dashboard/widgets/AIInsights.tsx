...
const AIInsights: React.FC = () => {
  ...
  return (
    <div className="w-full">
      ...
      {insights.length === 0 ? (
        <div className="bg-slate-900/60 backdrop-blur-xl border border-white/10 shadow-xl rounded-2xl p-6 text-center">
            <div className="w-10 h-10 bg-slate-800/50 rounded-full flex items-center justify-center mx-auto mb-3 border border-slate-700">
                <Lightbulb className="w-5 h-5 text-slate-500" />
            </div>
            <h4 className="text-slate-300 font-bold text-xs mb-1">No Insights Yet</h4>
