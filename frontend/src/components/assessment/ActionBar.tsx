...
const ActionBar: React.FC<ActionBarProps> = ({ 
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-xl border-t border-sky-200 z-40 p-4 shadow-2xl">
          ...
          {isLast ? (
            ...
            <button 
              ...
              className={`saas-button-primary flex items-center gap-2 ${
                !canNext ? 'opacity-50 cursor-not-allowed bg-sky-100 border-sky-200 text-slate-500 shadow-none hover:bg-sky-100 transform-none' : ''
              }`}
            >
              <span>Next</span>
